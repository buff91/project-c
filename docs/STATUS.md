...
- **최근 검증 기준**: `./Tools/CoreTests/run-core-tests.sh` **758/758 통과**(2026-07-25, 진행 방향 계약 테스트 포함).
  Unity 에디터에서의 EditMode/PlayMode 전체 수치는 **재확인이 필요하다** — 옛 "673/673" 기록은
  낡았다(그 시점 이후 컴파일되지 않는 테스트가 커밋된 적이 있다).
