...
- **최근 검증 기준** — **숫자에는 반드시 기준 커밋 해시를 함께 적는다.** 해시 없는 개수는
  ...
  - Core shim `./Tools/CoreTests/run-core-tests.sh` **1033/1033 통과** (`9d6a37e` + 미커밋 작업 트리,
    2026-07-29 실측).
  - ArtPipeline Python 회귀 **106/106 통과** (`fa6c90e` + 미커밋 작업 트리, 2026-07-28 실측).
  - Unity EditMode `ProjectC.Tests.EditMode` **1197/1197 통과** (`9d6a37e` + 미커밋 작업 트리,
    2026-07-29 에디터 실측, 27.2s).
  - Unity PlayMode `ProjectC.Tests.PlayMode` **2/2 통과** (`9d6a37e` + 미커밋 작업 트리,
    같은 세션, 3.2s) —
