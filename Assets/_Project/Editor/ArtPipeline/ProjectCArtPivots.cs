    ...
    public static class ProjectCArtPivots
    {
        ...
        private static readonly Dictionary<string, Vector2> Pivots =
            new Dictionary<string, Vector2>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "env-floor-b2-cracked", Centered },
                { "env-floor-b2-parking-stop-view-0", Centered },
                { "env-floor-b2-parking-stop-view-1", Centered },
                { "env-floor-b2-parking-stop-view-2", Centered },
                { "env-floor-b2-parking-stop-view-3", Centered },
                { "env-floor-b2-fallen-sign-view-0", Centered },
                { "env-floor-b2-fallen-sign-view-1", Centered },
                { "env-floor-b2-fallen-sign-view-2", Centered },
                { "env-floor-b2-fallen-sign-view-3", Centered },
                { "env-floor-b2-barrel-bay-service-view-0", Centered },
                { "env-floor-b2-barrel-bay-service-view-1", Centered },
                { "env-floor-b2-barrel-bay-service-view-2", Centered },
                { "env-floor-b2-barrel-bay-service-view-3", Centered },
                { "env-floor-b2-barrel-bay-drain-view-0", Centered },
                { "env-floor-b2-barrel-bay-drain-view-1", Centered },
                { "env-floor-b2-barrel-bay-drain-view-2", Centered },
                { "env-floor-b2-barrel-bay-drain-view-3", Centered },
                { "env-floor-b2-macro-role-0-view-0", Centered },
                { "env-floor-b2-macro-role-0-view-1", Centered },
                { "env-floor-b2-macro-role-0-view-2", Centered },
                { "env-floor-b2-macro-role-0-view-3", Centered },
                { "env-floor-b2-macro-role-1-view-0", Centered },
                { "env-floor-b2-macro-role-1-view-1", Centered },
                { "env-floor-b2-macro-role-1-view-2", Centered },
                { "env-floor-b2-macro-role-1-view-3", Centered },
                { "env-floor-b2-macro-role-2-view-0", Centered },
                { "env-floor-b2-macro-role-2-view-1", Centered },
                { "env-floor-b2-macro-role-2-view-2", Centered },
                { "env-floor-b2-macro-role-2-view-3", Centered },
                { "env-floor-b2-macro-role-3-view-0", Centered },
                { "env-floor-b2-macro-role-3-view-1", Centered },
                { "env-floor-b2-macro-role-3-view-2", Centered },
                { "env-floor-b2-macro-role-3-view-3", Centered },
                ...
                { "env-wall-b2-service-segment-0-rising-right", new Vector2(0.5f, 16f / 112f) },
                { "env-wall-b2-service-segment-0-rising-left", new Vector2(0.5f, 16f / 112f) },
                { "env-wall-b2-service-segment-1-rising-right", new Vector2(0.5f, 16f / 112f) },
                { "env-wall-b2-service-segment-1-rising-left", new Vector2(0.5f, 16f / 112f) },
                { "env-wall-b2-service-segment-2-rising-right", new Vector2(0.5f, 16f / 112f) },
                { "env-wall-b2-service-segment-2-rising-left", new Vector2(0.5f, 16f / 112f) },
