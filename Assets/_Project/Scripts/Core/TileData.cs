namespace ProjectC.Core
{
    ...
    public class TileData
    {
        ...
        public bool IsSolidGround => kind == TileKind.Floor || kind == TileKind.Stairs;

        /// <summary>이동으로 진입 가능한가.</summary>
        public bool IsWalkable => kind == TileKind.Floor || kind == TileKind.Stairs || kind == TileKind.WeakFloor;

        /// <summary>시야를 차단하는가. (FOV / 조준용)</summary>
        public bool BlocksSight => kind == TileKind.Wall;
